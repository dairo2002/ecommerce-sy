 ...
 */
final class Version20260720220420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carritocompras ADD CONSTRAINT FK_BED5150A639DDEED FOREIGN KEY (item_carrito_id) REFERENCES item_carrito (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item_carrito ADD CONSTRAINT FK_7CBB9881AADA8017 FOREIGN KEY (carritocompras_id) REFERENCES carritocompras (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
